      ...
      <div className="auth-layout">
        <aside className="auth-aside" style={heroStyle}>
          <div className="auth-aside-copy">
            ...
            <h1>Crea tu perfil y guarda tus favoritos.</h1>
            <p>
              Crea tu cuenta para guardar favoritos, comprar más rápido y seguir de cerca tus próximos pedidos.
            </p>
          </div>
        </aside>
        ...
        <div className="auth-panel">
          ...
          <p className="auth-panel-intro">
            Completa tus datos y deja listo tu acceso para comprar, guardar prendas y revisar tus pedidos cuando quieras.
          </p>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="auth-actions">
              ...
              <span className="auth-inline-link">Acceso rápido para guardar tus favoritos y comprar con más comodidad.</span>
            </div>
          </form>

          <div className="auth-footer">
            <p>
              ¿Ya tienes una cuenta? <Link to="/login" className="auth-text-link">Inicia sesión</Link>
            </p>
          </div>
        </div>
      </div>
