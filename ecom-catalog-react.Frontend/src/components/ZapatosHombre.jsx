 ...
 * 
 * Este componente representa la pÃ¡gina de zapatos para la secciÃ³n de hombres.
 ...
 * @constant {string}
 */
const API_URL = config.productCategoryUrl(16);
...
const HeroSection = () => (
  <div className="zapatos-hombre-hero">
    <div className="zapatos-hombre-content">
      <h1>Zapatos</h1>
      <p>Descubre nuestra colecciÃ³n de zapatos para hombre</p>
    </div>
  </div>
);
