...
const menus = {
  ...
  mujer: [
    { id: 10, name: 'Novedades', path: '/mujeres/novedades' },
    ...
    { id: 6, name: 'Accesorios', path: '/mujeres/accesorios' },
    { id: 5, name: 'Colecciones', path: '/colecciones' },
    { id: 7, name: 'Rebajas', path: '/mujeres/rebajas', sale: true },
  ],
  hombre: [
    { id: 10, name: 'Novedades', path: '/hombres/novedades' },
    ...
    { id: 6, name: 'Accesorios', path: '/hombres/accesorios' },
    { id: 5, name: 'Colecciones', path: '/colecciones' },
    { id: 7, name: 'Rebajas', path: '/hombres/rebajas', sale: true },
  ],
...
const CategoryMenu = ({ section }) => {
  ...
  return (
    ...
    <nav className="fashion-category-menu" aria-label="Categorías del catálogo">
        ...
        {currentCategories.map((category) => {
          ...
          return (
            ...
            <li key={category.id} className={isActive ? 'is-active' : ''}>
              ...
              <Link to={category.path} style={category.sale ? { color: '#c41e3a', fontWeight: 600 } : undefined}>{category.name}</Link>
